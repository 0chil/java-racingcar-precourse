...
public class TrialCountDTO {
	...
	private static final String TRIAL_COUNT_EXCEPTION_MESSAGE = "시도 횟수는 " + TRIAL_COUNT_MIN + " 이상이어야 합니다";
	...
	private void validateTrialCount(int trialCount) {
		if (trialCount < TRIAL_COUNT_MIN) {
			throw new IllegalArgumentException(TRIAL_COUNT_EXCEPTION_MESSAGE);
		}
	}
